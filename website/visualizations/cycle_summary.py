...
import json
from ..models import School_Profiles_Data, School_Stats, School, Cycle
from .. import db
from flask import url_for
import pandas as pd

def map(year):
    '''Generates map of the schools applied to within a cycle.'''
    year_cycles = Cycle.query.filter_by(cycle_year=year).all()
    print(year_cycles)
