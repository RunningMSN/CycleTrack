...
def explorer_home():
    ...
    for school in all_schools:
        ...
        if reg_num > 0 or phd_num > 0:
            ...
            build_df['intermediate_name'].append(school.intermediate_name)
...
def explore_school(school_name):
    ...
    reg_info = {'app_count': school_stats.reg_apps_count,
                ...
                'map': school_stats.reg_states_map,
                'mcat_gpa': school_stats.reg_mcat_gpa,
    ...
    phd_info = {'app_count': school_stats.phd_apps_count,
                ...
                'map': school_stats.phd_states_map,
                'mcat_gpa': school_stats.phd_mcat_gpa,
